...
%Particle Identification (PID) and low-momentum tracking capabilities are among the strongest points of ALICE.
...
%, extracted from a MC simulation (see Section~\ref{sect:detperf}).
