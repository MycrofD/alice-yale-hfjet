...
as compared to those where the charm content arose later in the
...
We present the current status of the \mbox{ALICE} measurement of jets that contain a D meson (D-tagged jet).
