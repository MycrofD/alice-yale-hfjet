...
\scriptsize \href{https://doi.org/10.1103/PhysRevD.85.052005}{PRD 85, 052005 (2012)}
\end{flushright}
}
...
\item Low jet momentum range: data agrees with theory
\item Intermediate jet momentum range: indication of a softer fragmentation in data compared to theory
\item To do: separate different production mechanisms in MC
}
\only<4>{
\item Similar observation from ATLAS
\item Data shows softer fragmentation compared to MC
}
\end{itemize}
\only<4>{
\vspace{-15pt}
\begin{center}
\begin{overpic}[width=.75\textwidth, trim=90 550 300 45, clip]{img/misc/2012-ATLAS-DstarInJets}
\end{overpic}
\end{center}
}
\end{columns}
